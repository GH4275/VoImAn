#WAS NAMED: test_single_trial_RAM_DISK_5.4_simple.py in development, renamed to volpy_analysis_solo.py for clarity and to be used in batch script with GUI version
