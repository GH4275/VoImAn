...
fnames = r'C:\Users\ICNLab\caiman_data\testdata\testdata\FOV3_T3new\FOV3_T3.tsm'
fr = 640
print(fname, fr)
...
##
print("Applying shifts to movie...")
# apply shifts to movie and save it
...
mmap_file_rig = np.memmap(ram_path, dtype='float32', mode='w+', shape=m_rig.shape, order='C') 
...
print("Computing local correlations movie in memory...")
...
opts_dict={'fnames': mmap_file_rig,   #'fnames': fname_new,
           'ROIs': ROIs,
           'index': index,
           'weights': weights,
...
##
fig.savefig(fnames[:-6] + '_volpy_ridge.pdf')