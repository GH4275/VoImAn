...
# # python C:\Users\ICNLab\caiman_data\test_single_trial_RAM_DISK_2.py C:\Users\ICNLab\caiman_data\testdata\testdata\FOV1_T2RAM2\FOV1_T2.tsm
...
def main():
    ...
    print("Saved VOLPY figure to:", fname[:-6] + '_volpy_ridge.pdf')
